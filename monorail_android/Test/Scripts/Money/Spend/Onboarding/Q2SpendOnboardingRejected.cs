...
namespace monorail_android.Test.Scripts.Money.Spend.Onboarding
{
    [TestFixture]
    [AllureNUnit]
    internal class Q2SpendOnboardingRejected : FunctionalTesting
    {
        private const string UsernamePrefix = "autotests.mono+23.";
        private const string UsernameSuffix = "@gmail.com";

        [Test(Description = "Q2 Spend Onboarding - account in 'Rejected' state")]
        [AllureEpic("Money")]
        [AllureFeature("Spend")]
        [AllureStory("Q2 Spend Onboarding - account in 'Rejected' state")]
        public void Q2SpendOnboardingRejectedTest()
        {
