...
namespace monorail_android.Test.Scripts.Money.Save.Onboarding
{
    [TestFixture]
    [AllureNUnit]
    internal class Q2SaveOnboardingManualReview : FunctionalTesting
    {
        private const string UsernamePrefix = "autotests.mono+25.";
        private const string UsernameSuffix = "@gmail.com";

        [Test(Description = "Q2 Save Onboarding - account in 'Manual Review'")]
        [AllureEpic("Money")]
        [AllureFeature("Save")]
        [AllureStory("Q2 Save Onboarding - account in 'Manual Review'")]
        public void Q2SaveOnboardingManualReviewTest()
        {
            ...
            RegisterUser(username, Q2ManualReviewDateOfBirthYmd);
            ...
            /* Because of BUG: 37760
               Manual Review status cannot be verified on Save page.
